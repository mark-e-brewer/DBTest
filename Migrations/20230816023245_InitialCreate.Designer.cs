...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20230816023245_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 1,
                            CheckinDate = new DateTime(2023, 8, 16, 21, 32, 45, 251, DateTimeKind.Local).AddTicks(1180),
                            CheckoutDate = new DateTime(2023, 8, 20, 21, 32, 45, 251, DateTimeKind.Local).AddTicks(1226),
                            UserProfileId = 1
                        });
                });
