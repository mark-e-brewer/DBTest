        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://example.com/image2.jpg", "Riverside Retreat" },
                    { 3, 1, "https://example.com/image3.jpg", "Forest Haven" },
                    { 4, 3, "https://example.com/image4.jpg", "Primitive Paradise" },
                    { 5, 4, "https://example.com/image5.jpg", "Hammock Hideaway" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 1, new DateTime(2023, 8, 16, 21, 32, 45, 251, DateTimeKind.Local).AddTicks(1180), new DateTime(2023, 8, 20, 21, 32, 45, 251, DateTimeKind.Local).AddTicks(1226), 1 });
